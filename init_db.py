...
def init_database():
    ...
    contacts_data = [
        ('Директор', 'Белова Елена Ивановна', '+7 (3412) 37-02-88', 'ikoopteh@mail.ru'),
        ('Заместитель директора по учебно-методической работе', 'Зуева Татьяна Петровна', '+7 (3412) 37-02-88', 'ikoopteh@mail.ru'),
        ('Заместитель директора по воспитательной работе', 'Морсеева Марина Николаевна', '+7 (3412) 37-02-88', 'ikoopteh@mail.ru'),
        ('Главный бухгалтер', 'Кузьмицкая Светлана Васильевна', '+7 (3412) 37-02-88', 'ikoopteh@mail.ru')
    ]
